...
public class DevDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Exercise progressing = workoutService.addExercise("Supino reto", "Peito");
        ...
        Exercise strong = workoutService.addExercise("Levantamento terra", "Posterior de coxa");
        ...
        Exercise stagnant = workoutService.addExercise("Rosca direta", "Bíceps");
